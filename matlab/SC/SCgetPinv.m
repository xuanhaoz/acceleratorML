...
% *SCgetModelRM*
	...
	%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
	% added by F.Zhang 10/05/2024, defines proportion of total SVs to include
	...
	if par.N~=0
		%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
		% changed by F.Zhang 10/05/2025 to define par.N as the number of SVs kept, starting from largest
		%
		% original
		% 
	...
	elseif par.fracSV < 1
		keep = round(length(SVs)*par.fracSV);
